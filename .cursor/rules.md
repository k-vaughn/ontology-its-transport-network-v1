...
- File organization for this project:
  ...
  - The project contains one master ontology file; its name is the preferred prefix of the ontology with a ttl extension (e.g., its-time.ttl). The master file imports the more modular pattern (*.*-pattern.ttl) files.
